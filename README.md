...
The ansible enabled docker image used in examples here can be found on [dockerhub](https://hub.docker.com/repository/docker/lj020326/docker-ansible-test).  
...
[![Docker Pulls - centos7-systemd-python](https://img.shields.io/docker/pulls/lj020326/docker-ansible-test.svg?style=flat)](https://hub.docker.com/repository/docker/lj020326/docker-ansible-test/)
...
Alternatively, you can clone this repository, build the image from the Dockerfile, and then run the container
    ...
    docker build -t docker-ansible-test .
